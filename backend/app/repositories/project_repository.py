"""Persistencia de proyectos, sprints e issues locales."""

from __future__ import annotations

from sqlalchemy.orm import Session

from app.models import Board, Issue, Project, Sprint
...
class ProjectRepository:
    ...
    def get_by_id(self, project_id: int) -> Project | None:
        return self.db.query(Project).filter(Project.id_project == project_id).first()
